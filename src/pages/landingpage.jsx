        ...
        <div className="max-w-2xl mx-auto">
          ...
          <form onSubmit={handleTrack} className="flex gap-3">
            ...
            <button
              ...
              className="bg-[#5bbfe8] hover:bg-[#3aaad4] disabled:opacity-50 text-white font-semibold px-6 py-3 rounded-lg transition text-sm shadow whitespace-nowrap flex items-center gap-2">
              {tracking
                ? <>
